...
- [ ] Userspace map management (add/remove/update rule entries live) <!-- partial 2026-04-19: ebpf/userspace/BlocklistLoader covers the v4/v6 blocklist maps; backend/internal/ebpf.Syncer interface + NoopSyncer default + FakeSyncer test double bridge DB↔kernel; full rule-sync layer pending rule_meta and rate_state programs. -->
